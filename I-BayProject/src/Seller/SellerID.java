...
/**
 * La classe SellerID implementa la descrizione di un venditore in una asta on-line.
 */
...
public class SellerID implements Serializable
{
	...
	public SellerID( String n, InetAddress IP, int p ) {
		name = n;
		IPAddress = IP;
		port = p;
	}
	...
	public boolean equals( Object obj ) {
		...
		if ( !( obj instanceof SellerID ) )	return false;
